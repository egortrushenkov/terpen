...
const createAccordion = accordion => {
  ...
  let timeOut;
  const setAccordionHeight = function () {
    let duration = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
    if (timeOut) clearTimeout(timeOut);
    const scrollHeight = content.scrollHeight;
    const transitionDuration = duration ? Math.max(scrollHeight / 2, 100) : 0;
    content.style.height = "".concat(scrollHeight, "px");
    content.style.transitionDuration = "".concat(transitionDuration, "ms");
  ...
  if (accordion.hasAttribute('data-close-click')) {
    document.addEventListener('click', event => {
      if (event.target.closest('[data-close-click]') !== accordion && accordion.dataset.accordion === 'active') {
...
const setOffset = element => {
  return {
    top: element.getBoundingClientRect().top + (0,_utils__WEBPACK_IMPORTED_MODULE_0__.scrolledPage)().top,
    left: element.getBoundingClientRect().left + (0,_utils__WEBPACK_IMPORTED_MODULE_0__.scrolledPage)().left
  };
};
const setAnimation = () => {
  ...
  items.forEach(item => {
    ...
    const offsetTop = setOffset(item).top;
    const screenPosition = 3;
    let point = window.innerHeight - height / screenPosition;
    if (point > window.innerHeight) point = window.innerHeight - window.innerHeight / screenPosition;
    if ((0,_utils__WEBPACK_IMPORTED_MODULE_0__.scrolledPage)().top > offsetTop - point && (0,_utils__WEBPACK_IMPORTED_MODULE_0__.scrolledPage)().top < offsetTop + height) item.dataset.anim = 'show';
  });
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (() => {
  setAnimation();
...
/* harmony export */ });
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (() => {
  const cookies = document.querySelectorAll('*[data-cookie]');
  cookies.forEach(cookie => {
    if (!cookie) return;
    const id = cookie.id;
    const value = "cookie_".concat(id, "_active");
    if (document.cookie.indexOf(value) !== -1) {
      cookie.remove();
    } else {
      const button = cookie.querySelector('*[data-cookie-button]');
      const expires = Number(cookie.dataset.expires) || 7;
      const path = String(cookie.dataset.cookie) || '/';
      const date = new Date(new Date().getFullYear(), new Date().getMonth(), new Date().getDate() + expires).toUTCString();
      button.addEventListener('click', () => {
        document.cookie = "".concat(value, "=1; path=").concat(path, "; expires=").concat(date);
        cookie.remove();
      });
    }
  });
...
/* harmony import */ var _load_media__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./load-media */ "./src/ts/load-media.ts");
/* harmony import */ var _submit_handler__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./submit-handler */ "./src/ts/submit-handler.ts");



_fancyapps_ui__WEBPACK_IMPORTED_MODULE_0__.Fancybox.defaults.mainClass = 'fancybox-custom';
...
const dialog = {
  open: src => {
    window.Fancybox.show([{
      ...
      dragToClose: false,
      on: {
        done: () => (0,_load_media__WEBPACK_IMPORTED_MODULE_1__["default"])()
      }
    });
  },
  notClosing: src => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (() => {
  ...
  window.Fancybox.bind('[data-fancybox-form]', {
    ...
    on: {
        ...
        (0,_load_media__WEBPACK_IMPORTED_MODULE_1__["default"])();
        (0,_submit_handler__WEBPACK_IMPORTED_MODULE_2__.getStateSubmitBtn)();
      }
    }
  });
});
...
const filterCardsShowing = _ref => {
  ...
  if (condition) {
    ...
    setTimeout(() => item.classList.remove('translate-y-10', 'opacity-0'), 50);
  }
};
const filterHandler = _ref2 => {
  let {
    name,
    cards,
    plug
  ...
  cards.forEach(card => {
    const absence = String(card.dataset.filteringValue).split(' ').includes(name) === false;
    const showAll = name.toLowerCase() === 'all';
    filterCardsShowing({
      condition: absence && !showAll,
      item: card
    });
  });
  const allHidden = [...cards].every(card => card.classList.contains('hidden'));
  if (plug) filterCardsShowing({
    condition: !allHidden,
    item: plug
  });
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (() => {
  const filters = document.querySelectorAll('*[data-filtering]');
  filters.forEach(filter => {
    if (!filter) return;
    const value = String(filter.dataset.filtering);
    const categories = document.querySelectorAll("*[data-filtering-category=\"".concat(value, "\"]"));
    const cards = document.querySelectorAll("*[data-filtering-card=\"".concat(value, "\"]"));
    const plug = document.querySelector("*[data-filtering-plug=\"".concat(value, "\"]"));
    const line = document.querySelector("*[data-filtering-line=\"".concat(value, "\"]"));
    ...
    const currentCard = category => {
      ...
      if (line) {
        line.style.width = "".concat(category.offsetWidth, "px");
        line.style.left = "".concat(category.offsetLeft, "px");
      }
      filterHandler({
        name,
        cards,
...
/***/ "./src/ts/horizontal-scrolling.ts"
/*!****************************************!*\
  !*** ./src/ts/horizontal-scrolling.ts ***!
  \****************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _plugins_media__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../plugins/media */ "./plugins/media.ts");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils */ "./src/ts/utils/index.ts");


const setScrollingHeight = () => {
  const scrollings = document.querySelectorAll('*[data-scrolling]');
  scrollings.forEach(scrolling => {
    if (!scrolling) return;
    const horizontal = scrolling.querySelector('*[data-scrolling-horizontal]');
    const height = horizontal.scrollWidth - horizontal.clientWidth;
    scrolling.style.setProperty('--scroll-height', "".concat(height, "px"));
  });
};
const setHorizontalScrolling = () => {
  const scrollings = document.querySelectorAll('*[data-scrolling]');
  scrollings.forEach(scrolling => {
    if (!scrolling) return;
    const horizontal = scrolling.querySelector('*[data-scrolling-horizontal]');
    const offsetTop = (0,_utils__WEBPACK_IMPORTED_MODULE_1__.scrolledPage)().top;
    horizontal.scrollLeft = offsetTop + horizontal.offsetHeight - scrolling.offsetTop;
  });
};
const scrollingInViewport = () => {
  const clientWidth = document.documentElement.clientWidth;
  if (clientWidth < _plugins_media__WEBPACK_IMPORTED_MODULE_0__.media.md || clientWidth > _plugins_media__WEBPACK_IMPORTED_MODULE_0__.media.xxl) {
    document.removeEventListener('wheel', setHorizontalScrolling);
    document.removeEventListener('scroll', setHorizontalScrolling);
  } else {
    document.addEventListener('wheel', setHorizontalScrolling);
    document.addEventListener('scroll', setHorizontalScrolling);
  }
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (() => {
  setScrollingHeight();
  ...
  scrollingInViewport();
  window.addEventListener('resize', setScrollingHeight);
  window.addEventListener('resize', scrollingInViewport);
});
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (() => {
  document.addEventListener('input', event => {
    if (event.target.getAttribute('data-input') === 'name') inputName(event);
  });
});

/***/ },

/***/ "./src/ts/load-media.ts"
/*!******************************!*\
  !*** ./src/ts/load-media.ts ***!
  \******************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
/* harmony import */ var _sidebar__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./sidebar */ "./src/ts/sidebar.ts");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils */ "./src/ts/utils/index.ts");


/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (() => {
  const menu = document.getElementById('menu');
  if (!menu || !(0,_utils__WEBPACK_IMPORTED_MODULE_1__.touchDevice)()) return;
  const value = 100;
  let initialX;
  let currentX;
  let active = false;
  ...
  document.addEventListener('touchend', event => {
    if (!active) return;
    if (event.target.closest("#".concat(menu.id))) {
      if (initialX - currentX > value) (0,_sidebar__WEBPACK_IMPORTED_MODULE_0__.closeSidebar)(menu);
    } else {
      if (initialX <= 32 && initialX - currentX < -value) (0,_sidebar__WEBPACK_IMPORTED_MODULE_0__.openSidebar)(menu);
    }
    active = false;
  });
});
...
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__)
/* harmony export */ });
const setOutNumber = section => {
  const items = section.querySelectorAll('*[data-number]');
  items.forEach(item => {
    if (!item) return;
    const number = Number(item.dataset.number);
    const step = Number(item.dataset.numberStep) || 0.5;
    const time = Number(item.dataset.numberTime) * 1000 || 1000;
    const fixed = Number(item.dataset.numberFixed) || 0;
    const timer = Math.round(time / (number / step));
    let sum = 0;
...
const scrollToNumbers = () => {
  ...
  if (section && window.screen.height >= section.getBoundingClientRect().top) {
    ...
    document.removeEventListener('scroll', scrollToNumbers);
  }
};
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (() => document.addEventListener('scroll', scrollToNumbers));

/***/ },

/***/ "./src/ts/phone-mask.ts"
/*!******************************!*\
  !*** ./src/ts/phone-mask.ts ***!
  \******************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (() => {
  const phoneEvents = ['input', 'keyup', 'keydown', 'paste'];
  phoneEvents.forEach(phoneEvent => {
    document.addEventListener(phoneEvent, event => {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (() => {
  ...
  if (!header) return;
  const scrollHeader = () => {
    const currentOffsetTop = (0,_utils__WEBPACK_IMPORTED_MODULE_0__.scrolledPage)().top;
    header.offsetHeight / 2 < currentOffsetTop ? header.classList.remove('sm:bg-opacity-0') : header.classList.add('sm:bg-opacity-0');
  };
  scrollHeader();
...
const scrollToElement = block => {
  if (!block) return;
  const header = document.querySelector('*[data-header]');
  const offsetTop = block.getBoundingClientRect().top + (0,_utils__WEBPACK_IMPORTED_MODULE_0__.scrolledPage)().top - (header ? header.offsetHeight : 0);
  window.scrollTo({
    top: offsetTop,
    behavior: 'smooth'
  });
...
const openSidebar = sidebar => {
  (0,_utils__WEBPACK_IMPORTED_MODULE_1__.scrollbarHidden)();
  sidebar.dataset.sidebar = 'open';
};
const closeSidebar = sidebar => {
  (0,_utils__WEBPACK_IMPORTED_MODULE_1__.scrollbarShow)();
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (() => {
  document.addEventListener('click', event => {
    if (event.target.closest('[data-sidebar-open]')) {
      ...
      const sidebar = document.querySelector("#".concat(open.dataset.sidebarOpen));
      if (sidebar) openSidebar(sidebar);
    }
    if (event.target.closest('[data-sidebar-close]')) {
      const close = event.target;
      const sidebar = document.querySelector("#".concat(close.dataset.sidebarClose));
      if (sidebar) closeSidebar(sidebar);
    }
    if (event.target.hasAttribute('data-sidebar')) {
  ...
  window.addEventListener('resize', () => {
    ...
    sidebars.forEach(sidebar => {
      if (sidebar.dataset.sidebarResize) {
        const breakpoint = _plugins_media__WEBPACK_IMPORTED_MODULE_0__.media[sidebar.dataset.sidebarResize];
        if (document.documentElement.clientWidth > breakpoint) closeSidebar(sidebar);
      }
    });
  });
});
...
/* harmony import */ var _plugins_media__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ../../plugins/media */ "./plugins/media.ts");



swiper__WEBPACK_IMPORTED_MODULE_0__["default"].use([swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Navigation, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Pagination, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Scrollbar, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Autoplay, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Grid, swiper_modules__WEBPACK_IMPORTED_MODULE_1__.Thumbs]);
swiper__WEBPACK_IMPORTED_MODULE_0__["default"].defaults.touchStartPreventDefault = false;
window.Swiper = swiper__WEBPACK_IMPORTED_MODULE_0__["default"];
const createAdvantagesSlider = () => {
  const sliders = document.querySelectorAll('*[data-slider="advantages"]');
  sliders.forEach(slider => {
    if (!slider) return;
    const value = String(slider.dataset.slider);
    const swiper = slider.querySelector("*[data-slider-swiper=\"".concat(value, "\"]"));
    new window.Swiper(swiper, {
      ...
      breakpoints: {
        [_plugins_media__WEBPACK_IMPORTED_MODULE_2__.media.xl]: {
          spaceBetween: 24
        },
        [_plugins_media__WEBPACK_IMPORTED_MODULE_2__.media.md]: {
          spaceBetween: 32
        },
        [_plugins_media__WEBPACK_IMPORTED_MODULE_2__.media.lg]: {
          spaceBetween: 40
        },
        [_plugins_media__WEBPACK_IMPORTED_MODULE_2__.media.xl]: {
          spaceBetween: 48
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (() => createAdvantagesSlider());

/***/ },

/***/ "./src/ts/submit-handler.ts"
/*!**********************************!*\
  !*** ./src/ts/submit-handler.ts ***!
  \**********************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "default": () => (__WEBPACK_DEFAULT_EXPORT__),
/* harmony export */   getStateSubmitBtn: () => (/* binding */ getStateSubmitBtn)
/* harmony export */ });
/* harmony import */ var _fancybox__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./fancybox */ "./src/ts/fancybox.ts");
/* harmony import */ var _utils__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./utils */ "./src/ts/utils/index.ts");


const getStateSubmitBtn = () => {
  const forms = document.querySelectorAll('*[data-form]');
  forms.forEach(form => {
    if (!form) return;
    const submitBtn = form.querySelector('button[type="submit"]');
    const toggles = form.querySelectorAll('*[data-toggle-submit]');
...
const formSubmitHandler = async event => {
  ...
  switch (form.dataset.form) {
    case '':
      {
        if (!(0,_utils__WEBPACK_IMPORTED_MODULE_1__.validation)(form)) event.preventDefault();
        break;
      }
    case 'submit':
      {
        event.preventDefault();
        if (!(0,_utils__WEBPACK_IMPORTED_MODULE_1__.validation)(form)) return;
        const formData = new FormData(form);
        const submitBtn = form.querySelector('button[type="submit"]');
        const requestUrl = '/ajax/php/submit-handler.php';
        submitBtn.disabled = true;
        _fancybox__WEBPACK_IMPORTED_MODULE_0__.dialog.notClosing('/ajax/dialogs/dialog-preloader.php');
        await fetch(requestUrl, {
          ...
          _fancybox__WEBPACK_IMPORTED_MODULE_0__.dialog.close();
          _fancybox__WEBPACK_IMPORTED_MODULE_0__.dialog.open(response.status ? '/ajax/dialogs/dialog-success.php' : '/ajax/dialogs/dialog-error.php');
          form.reset();
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (() => {
  ...
  document.addEventListener('submit', event => {
    if (event.target.hasAttribute('data-form')) formSubmitHandler(event);
  });
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   scrollbarHidden: () => (/* reexport safe */ _scrollbar__WEBPACK_IMPORTED_MODULE_1__.scrollbarHidden),
/* harmony export */   scrollbarShow: () => (/* reexport safe */ _scrollbar__WEBPACK_IMPORTED_MODULE_1__.scrollbarShow),
/* harmony export */   scrolledPage: () => (/* reexport safe */ _scrolled_page__WEBPACK_IMPORTED_MODULE_2__.scrolledPage),
/* harmony export */   touchDevice: () => (/* reexport safe */ _touch_device__WEBPACK_IMPORTED_MODULE_3__.touchDevice),
/* harmony export */   validation: () => (/* reexport safe */ _validation__WEBPACK_IMPORTED_MODULE_4__.validation)
/* harmony export */ });
/* harmony import */ var _coordinates__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./coordinates */ "./src/ts/utils/coordinates.ts");
/* harmony import */ var _scrollbar__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./scrollbar */ "./src/ts/utils/scrollbar.ts");
/* harmony import */ var _scrolled_page__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./scrolled-page */ "./src/ts/utils/scrolled-page.ts");
/* harmony import */ var _touch_device__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./touch-device */ "./src/ts/utils/touch-device.ts");
/* harmony import */ var _validation__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./validation */ "./src/ts/utils/validation.ts");
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   scrollbarHidden: () => (/* binding */ scrollbarHidden),
/* harmony export */   scrollbarShow: () => (/* binding */ scrollbarShow)
/* harmony export */ });
/* harmony import */ var _touch_device__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./touch-device */ "./src/ts/utils/touch-device.ts");

const scrollbarShow = () => {
  const html = document.documentElement;
  if (!(0,_touch_device__WEBPACK_IMPORTED_MODULE_0__.touchDevice)()) html.style.marginRight = '0';
  html.classList.remove('overflow-hidden');
};
const scrollbarHidden = () => {
  const html = document.documentElement;
  const scrollbarWidth = window.innerWidth - html.clientWidth;
  if (!(0,_touch_device__WEBPACK_IMPORTED_MODULE_0__.touchDevice)()) html.style.marginRight = "".concat(scrollbarWidth, "px");
  html.classList.add('overflow-hidden');
};

/***/ },

/***/ "./src/ts/utils/scrolled-page.ts"
/*!***************************************!*\
  !*** ./src/ts/utils/scrolled-page.ts ***!
  \***************************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   scrolledPage: () => (/* binding */ scrolledPage)
/* harmony export */ });
const scrolledPage = () => {
  return {
...
const validation = form => {
  const labels = form.querySelectorAll('*[data-label]');
  let validate = true;
  labels.forEach(label => {
    if (!label) return;
    const input = label.querySelector('*[data-input]');
    const error = label.querySelector('*[data-error]');
...
const setWaved = event => {
  if (event.target.closest('[data-waved]')) {
    const item = event.target.closest('[data-waved]');
    const waved = document.createElement('div');
    const circle = document.createElement('div');
    const createCircle = _ref => {
      let {
        positionY,
        positionX
      } = _ref;
      ...
      circle.style.top = "".concat(coordinates.top, "px");
      circle.style.left = "".concat(coordinates.left, "px");
      waved.classList.add('waved');
      waved.appendChild(circle);
      item.appendChild(waved);
      setTimeout(() => waved.remove(), 1000);
    };
    switch (event.type) {
      case 'touchstart':
        {
          if (!(0,_utils__WEBPACK_IMPORTED_MODULE_0__.touchDevice)()) return;
          createCircle({
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (() => {
  document.addEventListener('touchstart', setWaved);
  document.addEventListener('mousedown', setWaved);
});

/***/ },

/***/ "./src/ts/yandex-map.ts"
/*!******************************!*\
  !*** ./src/ts/yandex-map.ts ***!
  \******************************/
(__unused_webpack_module, __webpack_exports__, __webpack_require__) {
...
window.ymaps = ymaps__WEBPACK_IMPORTED_MODULE_0__["default"];
const createMap = () => {
  const yandexMap = document.querySelector('*[data-yandex-map]');
  if (!yandexMap) return;
  const src = String(yandexMap.dataset.src);
  const coordinates = String(yandexMap.dataset.yandexMap).split(',');
  const mark = [];
  for (let i = 0; i < coordinates.length; i++) {
    mark.push(Number(coordinates[i]));
  }
  window.ymaps.load('https://api-maps.yandex.ru/2.1/?lang=ru_RU').then(maps => {
...
const createLocation = () => {
  ...
  if (!location) return;
  const src = String(location.dataset.src);
  window.ymaps.load('https://api-maps.yandex.ru/2.1/?lang=ru_RU').then(maps => {
    const inputs = [...document.querySelectorAll('[data-suggest-view]')];
    const map = new maps.Map(location, {
      center: window.placemarks[0],
      zoom: 14
    });
    inputs.forEach(input => {
      new maps.SuggestView(input, {
    ...
    map.controls.remove('rulerControl');
    map.behaviors.disable(['scrollZoom']);
    window.placemarks.forEach(placemark => {
      map.geoObjects.add(new maps.Placemark(placemark, {}, {
        iconLayout: 'default#image',
        iconImageHref: src,
        iconImageSize: [37, 42],
        iconImageOffset: [-18.5, -21]
      }));
    });
  }).catch(error => console.log('Failed to load Yandex Maps', error));
};
...
/*!************************!*\
  ...
  \************************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _ts_accordion__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ts/accordion */ "./src/ts/accordion.ts");
/* harmony import */ var _ts_animation__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./ts/animation */ "./src/ts/animation.ts");
/* harmony import */ var _ts_cookie__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ts/cookie */ "./src/ts/cookie.ts");
/* harmony import */ var _ts_current_tab__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./ts/current-tab */ "./src/ts/current-tab.ts");
/* harmony import */ var _ts_fancybox__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./ts/fancybox */ "./src/ts/fancybox.ts");
/* harmony import */ var _ts_filtering__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./ts/filtering */ "./src/ts/filtering.ts");
/* harmony import */ var _ts_horizontal_scrolling__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./ts/horizontal-scrolling */ "./src/ts/horizontal-scrolling.ts");
/* harmony import */ var _ts_inputs__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./ts/inputs */ "./src/ts/inputs.ts");
/* harmony import */ var _ts_load_media__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./ts/load-media */ "./src/ts/load-media.ts");
/* harmony import */ var _ts_menu__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./ts/menu */ "./src/ts/menu.ts");
/* harmony import */ var _ts_out_number__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./ts/out-number */ "./src/ts/out-number.ts");
/* harmony import */ var _ts_phone_mask__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! ./ts/phone-mask */ "./src/ts/phone-mask.ts");
/* harmony import */ var _ts_preloader__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! ./ts/preloader */ "./src/ts/preloader.ts");
/* harmony import */ var _ts_scroll_header__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./ts/scroll-header */ "./src/ts/scroll-header.ts");
/* harmony import */ var _ts_scroll_to__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! ./ts/scroll-to */ "./src/ts/scroll-to.ts");
/* harmony import */ var _ts_sidebar__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! ./ts/sidebar */ "./src/ts/sidebar.ts");
/* harmony import */ var _ts_slider_swiper__WEBPACK_IMPORTED_MODULE_16__ = __webpack_require__(/*! ./ts/slider-swiper */ "./src/ts/slider-swiper.ts");
/* harmony import */ var _ts_submit_handler__WEBPACK_IMPORTED_MODULE_17__ = __webpack_require__(/*! ./ts/submit-handler */ "./src/ts/submit-handler.ts");
/* harmony import */ var _ts_waved__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! ./ts/waved */ "./src/ts/waved.ts");
/* harmony import */ var _ts_yandex_map__WEBPACK_IMPORTED_MODULE_19__ = __webpack_require__(/*! ./ts/yandex-map */ "./src/ts/yandex-map.ts");
/* harmony import */ var _fancyapps_ui_dist_fancybox_fancybox_css__WEBPACK_IMPORTED_MODULE_20__ = __webpack_require__(/*! @fancyapps/ui/dist/fancybox/fancybox.css */ "./node_modules/@fancyapps/ui/dist/fancybox/fancybox.css");
/* harmony import */ var swiper_css_bundle__WEBPACK_IMPORTED_MODULE_21__ = __webpack_require__(/*! swiper/css/bundle */ "./node_modules/swiper/swiper-bundle.css");
/* harmony import */ var _scss_main_scss__WEBPACK_IMPORTED_MODULE_22__ = __webpack_require__(/*! ./scss/main.scss */ "./src/scss/main.scss");
...
window.addEventListener('DOMContentLoaded', () => {
  (0,_ts_accordion__WEBPACK_IMPORTED_MODULE_0__["default"])();
  (0,_ts_animation__WEBPACK_IMPORTED_MODULE_1__["default"])();
  (0,_ts_cookie__WEBPACK_IMPORTED_MODULE_2__["default"])();
  (0,_ts_current_tab__WEBPACK_IMPORTED_MODULE_3__["default"])();
  (0,_ts_fancybox__WEBPACK_IMPORTED_MODULE_4__["default"])();
  (0,_ts_filtering__WEBPACK_IMPORTED_MODULE_5__["default"])();
  (0,_ts_horizontal_scrolling__WEBPACK_IMPORTED_MODULE_6__["default"])();
  (0,_ts_inputs__WEBPACK_IMPORTED_MODULE_7__["default"])();
  (0,_ts_menu__WEBPACK_IMPORTED_MODULE_9__["default"])();
  (0,_ts_out_number__WEBPACK_IMPORTED_MODULE_10__["default"])();
  (0,_ts_phone_mask__WEBPACK_IMPORTED_MODULE_11__["default"])();
  (0,_ts_scroll_header__WEBPACK_IMPORTED_MODULE_13__["default"])();
  (0,_ts_scroll_to__WEBPACK_IMPORTED_MODULE_14__["default"])();
  (0,_ts_sidebar__WEBPACK_IMPORTED_MODULE_15__["default"])();
  (0,_ts_slider_swiper__WEBPACK_IMPORTED_MODULE_16__["default"])();
  (0,_ts_submit_handler__WEBPACK_IMPORTED_MODULE_17__["default"])();
  (0,_ts_waved__WEBPACK_IMPORTED_MODULE_18__["default"])();
  (0,_ts_yandex_map__WEBPACK_IMPORTED_MODULE_19__["default"])();
  (0,_ts_preloader__WEBPACK_IMPORTED_MODULE_12__["default"])();
});
window.addEventListener('load', _ts_load_media__WEBPACK_IMPORTED_MODULE_8__["default"]);
})();
